...
//by Frank de Brabander and João Pedro São Gregorio Silva
#include <ELECHOUSE_CC1101_SRC_DRV.h>
#include <Wire.h>
#include <LiquidCrystal_I2C.h>
const float pulsePin = 3; // Input signal connected to Pin 12 of Arduino
...
void setup() {
    ...
    ELECHOUSE_cc1101.setMHZ(320.0);        // Here you can set your basic frequency. The lib calculates the frequency automatically (default = 433.92).The cc1101 can: 300-348 MHZ, 387-464MHZ and 779-928MHZ. Read More info from datasheet.
    ...
    ELECHOUSE_cc1101.setDRate(2.4);       // Set the Data Rate in kBaud. Value from 0.02 to 1621.83. Default is 99.97 kBaud!
...
frequency = 1000000.0 / pulseTotal; // Frequency in Hertz (Hz)
lcd.clear();
...
{
ELECHOUSE_cc1101.SendData("good frequency", 100);
//RX Mode
Serial.println("RX_mode");
lcd.clear();
lcd.print("HOLD");

delay(5100); //wait for end
lcd.clear();
lcd.print("RX Mode");
do
{
...
delay(7000);
lcd.clear();
lcd.print("switching to TX Mode"); 
}
delay(1000);
}
